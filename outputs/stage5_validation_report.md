...
> Generated 2026-08-09T09:15:52.417203+00:00.
...
|-----------|-----------|---------|--------|-----------|-----|-----------|---------------|-------------------|---------------|--------|-----------|-------|
| M≥5.0 | M≥5.0 | 7d | 0-24h | 200 | 51 | 0.255 | None | 0.2125 | 0.1924 | None | -0.0944 | Forced-ETAS does NOT beat Poisson (Brier 0.2125 >= |
| M≥5.0 | M≥5.0 | 7d | 1-7d | 200 | 44 | 0.22 | None | 0.1889 | 0.1719 | None | -0.0809 | Forced-ETAS does NOT beat Poisson (Brier 0.1889 >= |
| M≥5.0 | M≥5.0 | 7d | 8-30d | 200 | 38 | 0.19 | None | 0.1656 | 0.1538 | None | -0.0589 | Forced-ETAS does NOT beat Poisson (Brier 0.1656 >= |
| M≥5.0 | M≥5.0 | 7d | 31-90d | 200 | 45 | 0.225 | None | 0.1945 | 0.175 | None | -0.093 | Forced-ETAS does NOT beat Poisson (Brier 0.1945 >= |
| M≥5.0 | M≥5.0 | 7d | background | 44 | 10 | 0.2273 | None | 0.1975 | 0.1781 | None | -0.0975 | Forced-ETAS does NOT beat Poisson (Brier 0.1975 >= |
| M≥5.0 | M≥5.0 | 30d | 0-24h | 200 | 128 | 0.64 | None | 0.3425 | 0.232 | None | -0.2362 | Forced-ETAS does NOT beat Poisson (Brier 0.3425 >= |
| M≥5.0 | M≥5.0 | 30d | 1-7d | 200 | 123 | 0.615 | None | 0.3335 | 0.2359 | None | -0.2093 | Forced-ETAS does NOT beat Poisson (Brier 0.3335 >= |
| M≥5.0 | M≥5.0 | 30d | 8-30d | 200 | 123 | 0.615 | None | 0.3384 | 0.2433 | None | -0.2039 | Forced-ETAS does NOT beat Poisson (Brier 0.3384 >= |
| M≥5.0 | M≥5.0 | 30d | 31-90d | 200 | 111 | 0.555 | None | 0.3105 | 0.2493 | None | -0.132 | Forced-ETAS does NOT beat Poisson (Brier 0.3105 >= |
| M≥5.0 | M≥5.0 | 30d | background | 44 | 24 | 0.5455 | None | 0.3099 | 0.2616 | None | -0.106 | Forced-ETAS does NOT beat Poisson (Brier 0.3099 >= |
...
**Summary:** 0/23 externally-informed parameter sets beat Poisson (0.0%). Brier improvement range: [-0.0984, -0.0675], median -0.0921. **Robust: False** (>50% beat Poisson).

### OAT sweep results

| Parameter | Value | Brier ETAS | Brier Poisson | ΔBrier | IG | Beats? |
|-----------|-------|------------|---------------|--------|-----|--------|
| K | 0.005 | 0.340 | 0.241 | -0.098 | -0.214 | NO |
| K | 0.01 | 0.337 | 0.241 | -0.096 | -0.208 | NO |
| K | 0.02 | 0.333 | 0.241 | -0.092 | -0.198 | NO |
| K | 0.05 | 0.323 | 0.241 | -0.082 | -0.172 | NO |
| K | 0.1 | 0.309 | 0.241 | -0.068 | -0.141 | NO |
| alpha | 0.3 | 0.337 | 0.241 | -0.096 | -0.208 | NO |
| alpha | 0.5 | 0.336 | 0.241 | -0.095 | -0.205 | NO |
| alpha | 0.8 | 0.333 | 0.241 | -0.092 | -0.198 | NO |
| alpha | 1.0 | 0.331 | 0.241 | -0.090 | -0.192 | NO |
| alpha | 1.5 | 0.309 | 0.241 | -0.068 | -0.252 | NO |
| c_days | 0.01 | 0.335 | 0.241 | -0.094 | -0.202 | NO |
| c_days | 0.05 | 0.333 | 0.241 | -0.092 | -0.198 | NO |
| c_days | 0.1 | 0.333 | 0.241 | -0.091 | -0.197 | NO |
| c_days | 0.3 | 0.331 | 0.241 | -0.090 | -0.194 | NO |
| p | 1.05 | 0.335 | 0.241 | -0.094 | -0.203 | NO |
| p | 1.1 | 0.333 | 0.241 | -0.092 | -0.198 | NO |
| p | 1.2 | 0.335 | 0.241 | -0.094 | -0.202 | NO |
| p | 1.3 | 0.338 | 0.241 | -0.096 | -0.208 | NO |
| sigma_km | 3.0 | 0.333 | 0.241 | -0.092 | -0.198 | NO |
| sigma_km | 5.0 | 0.333 | 0.241 | -0.092 | -0.198 | NO |
| sigma_km | 10.0 | 0.333 | 0.241 | -0.092 | -0.198 | NO |
| sigma_km | 20.0 | 0.333 | 0.241 | -0.092 | -0.198 | NO |
| sigma_km | 50.0 | 0.333 | 0.241 | -0.092 | -0.198 | NO |
...
|-------|------------|---------------|--------|-----|--------|
| ogata1998_california | 0.333 | 0.241 | -0.092 | -0.197 | NO |
| zhuang2011_japan | N/A | 0.241 | N/A | N/A | NO |
| marsan2010_global | 0.334 | 0.241 | -0.093 | -0.201 | NO |
