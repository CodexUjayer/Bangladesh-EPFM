...
> Generated 2026-08-09T08:07:58.338248+00:00.
...
|----|-----------|----|------|--------|------|--------|------|------|-------|----|------|-------|
| 4.0 | 44.120 | 0 | 0.000 | 1.000 | 1.010 | 9.94 | 0.000 | 2.397 | -11483.6 | 2288 | Y | Parameter mu_total_per_year: flat_likelihood (not identifiable).; Parameter K: at_lower_bound (0 ≈ 1e-08). |
| 4.5 | 38.316 | 0 | 0.000 | 1.000 | 1.010 | 9.94 | 0.000 | 2.352 | -10454.2 | 1987 | Y | Parameter mu_total_per_year: flat_likelihood (not identifiable).; Parameter K: at_lower_bound (0 ≈ 1e-08). |
| 5.0 | 12.449 | 0 | 0.000 | 1.000 | 1.010 | 9.99 | 0.445 | 1.822 | -4180.2 | 640 | Y | Parameter mu_total_per_year: flat_likelihood (not identifiable).; Parameter K: at_lower_bound (0 ≈ 1e-08). |

### Parameter identifiability

| Mc | μ | K | α | c | p | σ | γ | q |
|----|----|----|------|------|------|------|------|------|
| 4.0 | flat_likelihood (not identifiable) | at_lower_bound (0 ≈ 1e-08) | at_lower_bound (0 ≈ 0) | at_upper_bound (1 ≈ 1) | at_lower_bound (1.01 ≈ 1.01) | flat_likelihood (not identifiable) | at_lower_bound (0 ≈ 0) | flat_likelihood (not identifiable) |
| 4.5 | flat_likelihood (not identifiable) | at_lower_bound (0 ≈ 1e-08) | at_lower_bound (0 ≈ 0) | at_upper_bound (1 ≈ 1) | at_lower_bound (1.01 ≈ 1.01) | flat_likelihood (not identifiable) | at_lower_bound (0 ≈ 0) | flat_likelihood (not identifiable) |
...
|----|----|---------------------|--------------|------------------|----------------------|-------|
| 4.0 | 2288 | 1.000 | 0.069 | 236350737.8 (64) | True | Rolling rate in transformed time varies by >2x; remaining non-Poisson structure. Identify where (see spatial residuals). |
| 4.5 | 1987 | 1.001 | 0.071 | 197977204.8 (64) | True | Rolling rate in transformed time varies by >2x; remaining non-Poisson structure. Identify where (see spatial residuals). |
| 5.0 | 640 | 1.002 | 0.077 | 61961086.0 (64) | True | Rolling rate in transformed time varies by >2x; remaining non-Poisson structure. Identify where (see spatial residuals). |
...
|-----------|---------|--------|-----------|-----|-----------|----------------|-------------------|---------------|----------------|-----------|------------------|-------|
| M≥4.5 | 7d | post_mainshock | 1920 | 919 | 0.4786 | None | 0.4145 | 0.3791 | -0.0354 | -0.212 | 0.5991 | FORCED-ETAS does NOT beat Poisson (Brier 0.4145 >= |
| M≥4.5 | 30d | post_mainshock | 1919 | 1735 | 0.9041 | None | 0.5013 | 0.3229 | -0.1785 | -0.4064 | 0.7199 | FORCED-ETAS does NOT beat Poisson (Brier 0.5013 >= |
| M≥5.0 | 7d | post_mainshock | 1920 | 426 | 0.2219 | None | 0.2093 | 0.2219 | 0.0126 | 5.329 | 0.5427 | FORCED-ETAS BEATS Poisson (Brier 0.2093 < 0.2219). |
| M≥5.0 | 30d | post_mainshock | 1919 | 1167 | 0.6081 | None | 0.4819 | 0.6081 | 0.1263 | 15.4358 | 0.5017 | FORCED-ETAS BEATS Poisson (Brier 0.4819 < 0.6081). |
...
2. **By how much?** Mean Brier improvement (Forced-ETAS vs Poisson) in post-mainshock windows: -0.0188; mean information gain: 5.0366.
